...
public class Scenario {
    private double mInvestmentValue;
    private int mStartYear;
    private final int mEndYear;
    private final double nInterestIncomeRate;

    public Scenario(String[] args) {
        mInvestmentValue = 150000   // kids inheritance
                         +  48000   // eTrade
                         +  49000   // Ameritrade trading acct
                         +  72000   // Schwab
                         +  22000   // Ameritrade IRAs
                         + 137000   // Securion
                         +  68000   // TIAA Creff
            ;
        mStartYear = 2015;
    ...
    private void print() {
        print(String.format("Initial investment $%.0f", mInvestmentValue));
        print(String.format("Annual investment income rate %.4f", nInterestIncomeRate));
        print(String.format("Start-end years: %d-%d", mStartYear, mEndYear));
    }
